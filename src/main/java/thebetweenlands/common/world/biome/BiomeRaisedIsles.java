...
public class BiomeRaisedIsles extends BiomeBetweenlands {
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new SurfaceSpawnEntry(0, EntityDragonFly.class, EntityDragonFly::new, (short) 36).setCanSpawnOnWater(true).setGroupSize(1, 3).setSpawnCheckRadius(26.0D).setSpawningInterval(400));
		...
		entries.add(new SurfaceSpawnEntry(2, EntityGecko.class, EntityGecko::new, (short) 52).setGroupSize(1, 3).setSpawnCheckRadius(24.0D).setSpawningInterval(600));
		entries.add(new SurfaceSpawnEntry(3, EntityFrog.class, EntityFrog::new, (short) 30).setCanSpawnOnWater(true).setGroupSize(1, 3).setSpawnCheckRadius(24.0D).setSpawningInterval(100));
		...
		entries.add(new SporelingSpawnEntry(5, EntitySporeling.class, EntitySporeling::new, (short) 80).setGroupSize(2, 5).setSpawnCheckRadius(24.0D));
		entries.add(new SurfaceSpawnEntry(6, EntityRootSprite.class, EntityRootSprite::new, (short) 70).setSurfacePredicate(state -> state.getBlock() == BlockRegistry.GIANT_ROOT).setGroupSize(1, 3).setSpawnCheckRadius(24.0D).setSpawningInterval(200));
		...
		entries.add(new SurfaceSpawnEntry(13, EntityWight.class, EntityWight::new, (short) 8).setHostile(true).setSpawnCheckRadius(30.0D).setSpawnCheckRangeY(16.0D).setSpawningInterval(6000));
		entries.add(new CaveSpawnEntry(14, EntityWight.class, EntityWight::new, (short) 20).setHostile(true).setSpawnCheckRadius(30.0D));
		entries.add(new SurfaceSpawnEntry(15, EntityChiromaw.class, EntityChiromaw::new, (short) 40).setHostile(true).setSpawnCheckRadius(24.0D));
		...
		entries.add(new SkySpawnEntry(18, EntityChiromawGreeblingRider.class, EntityChiromawGreeblingRider::new, (short) 20).setSpawnCheckRadius(28.0D).setGroupSize(1, 3).setSpawningInterval(600).setHostile(true));
		entries.add(new PitstoneCaveSpawnEntry(19, EntityStalker.class, EntityStalker::new, (short) 15).setConstantWeight(true).setHostile(true).setSpawnCheckRadius(30.0D).setSpawnCheckRangeY(16).setSpawningInterval(6000));
		entries.add(new CaveSpawnEntry(20, EntitySwarm.class, EntitySwarm::new, (short) 60).setConstantWeight(true).setHostile(true).setSpawnCheckRadius(26.0D));
		...
		entries.add(new CaveSpawnEntry(22, EntityCaveFish.class, EntityCaveFish::new, (short) 30).setCanSpawnInWater(true).setGroupSize(1, 3).setSpawnCheckRadius(24.0D));
